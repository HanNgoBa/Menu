const menu = [
  ...
  const items = document.getElementById('food');
  ...
  function displayMenuItems1(menu, category){
    const a = menu.map((item)=>{
  ...
  function displayMenuButtons (number){
    if(number==1)
    {
      displayMenuItems(menu);
    }
    if(number==2)
    {
      displayMenuItems1(menu,"breakfast");
    }
    if(number==3)
    {
      displayMenuItems1(menu,"lunch");
    }
    if(number==4)
    {
      displayMenuItems1(menu,"shakes");
    }
    if(number==5)
    {
      displayMenuItems1(menu,"dinner");
    }
  }
